...
namespace odfaeg
{
    namespace physic {
        namespace ecs {
            ...
            class ODFAEG_PHYSICS_API ParticleSystem : public core::Timer, private sf::NonCopyable, private EmissionInterface
            {
            // ---------------------------------------------------------------------------------------------------------------------------
            // Private types
            private:
            ...
            ParticleSystem(math::Vec3f position, math::Vec3f size, graphic::ecs::EntityFactory& factory);

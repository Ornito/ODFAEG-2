...
namespace odfaeg {
    namespace graphic {
        ...
        public :
            ...
            ///
            ////////////////////////////////////////////////////////////
            bool create(unsigned int width, unsigned int height, window::ContextSettings = window::ContextSettings(), unsigned int textureType = 0x0DE1, bool useSeparateContext = false, unsigned int precision = 0x8058,unsigned int format = 0x1908, unsigned int type = 0x1401);
            ////////////////////////////////////////////////////////////

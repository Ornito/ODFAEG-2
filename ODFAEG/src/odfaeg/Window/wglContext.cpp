...
namespace odfaeg {
    namespace window {
        ...
        ////////////////////////////////////////////////////////////
        WglContext::create(IContext* shared) :
        m_window       (NULL),
        m_pbuffer      (NULL),
        m_deviceContext(NULL),
        m_context      (NULL),
        m_ownsWindow   (false)
        {
            ...
            WglContext w32shared = (shared != nullptr) ? static_cast<WglContext*>(sharedContext)->m_context : nullptr;
        ...
        ////////////////////////////////////////////////////////////
        WglContext::create(HWND owner,  const ContextSettings& settings, IContext* shared, unsigned int bitsPerPixel) :
        m_window       (NULL),
        m_pbuffer      (NULL),
        m_deviceContext(NULL),
        m_context      (NULL),
        ...
        ////////////////////////////////////////////////////////////
        WglContext::create(const ContextSettings& settings, unsigned int width, unsigned int height, WglContext* shared) :
        m_window       (NULL),
        m_pbuffer      (NULL),
        m_deviceContext(NULL),
        m_context      (NULL),

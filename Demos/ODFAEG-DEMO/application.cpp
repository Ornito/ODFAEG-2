...
namespace sorrok {
    ...
    void MyAppli::onInit () {
       ...
       /* sf::Vector3f acceleration(0, -1, 0);
        ...
        View view = getView();
        //view.rotate(0, 0, 20);
        PerPixelLinkedListRenderComponent *frc1 = new PerPixelLinkedListRenderComponent(getRenderWindow(),0, "E_BIGTILE", true, ContextSettings(0, 0, 4, 4, 6));
        PerPixelLinkedListRenderComponent *frc2 = new PerPixelLinkedListRenderComponent(getRenderWindow(), 1, "E_WALL+E_DECOR+E_ANIMATION+E_HERO+E_PARTICLES", true, ContextSettings(0, 0, 4, 4, 6));
